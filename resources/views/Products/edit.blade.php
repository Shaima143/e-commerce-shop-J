        ...
        <div class="container pt-3">
            ...
            <form action="/products/update/{{ $product->id }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <br>
                    <img src="{{ asset($product->image_path) }}" style="max-height: 100px">
                </div>

                <div class="mb-3">
                    <label for="category_id" class="form-label">{{ __('Category ID') }}</label>
                    <input type="number" class="form-control" id="category_id" aria-describedby="emailHelp" name="category_id" value="{{ $product->category_id }}">
                </div>
